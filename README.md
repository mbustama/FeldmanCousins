...
The test suite currently comprises 148 tests across 23 files under `tests/` (143 always run, plus 5 UltraNest-specific tests that skip automatically if the optional `ultranest` package isn't installed), grouped into four categories:
