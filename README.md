...
The test suite currently comprises 153 tests across 24 files under `tests/` (148 always run, plus 5 UltraNest-specific tests that skip automatically if the optional `ultranest` package isn't installed), grouped into four categories:
