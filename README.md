...
The test suite currently comprises 177 tests across 26 files under `tests/` (160 always run, plus 17 UltraNest-specific tests that skip automatically if the optional `ultranest` package isn't installed), grouped into four categories:
