...
The test suite currently comprises 143 tests across 22 files under `tests/` (138 always run, plus 5 UltraNest-specific tests that skip automatically if the optional `ultranest` package isn't installed), grouped into four categories:
